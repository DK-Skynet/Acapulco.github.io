...
// Pano2VR 5.2.4/15996
// Filename: my.ggsk
// Generated Tue May 22 16:38:19 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._popup_image0.ggVisible=false;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_image') {
			...
			this._ht_image_image0=document.createElement('div');
			this._ht_image_image0__img=document.createElement('img');
			this._ht_image_image0__img.className='ggskin ggskin_svg';
			this._ht_image_image0__img.setAttribute('src',basePath + 'images/ht_image_image0.svg');
			this._ht_image_image0__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
			this._ht_image_image0__img['ondragstart']=function() { return false; };
			this._ht_image_image0.appendChild(this._ht_image_image0__img);
			this._ht_image_image0__imgo=document.createElement('img');
			this._ht_image_image0__imgo.className='ggskin ggskin_svg';
			this._ht_image_image0__imgo.setAttribute('src',basePath + 'images/ht_image_image0__o.svg');
			this._ht_image_image0__imgo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;');
			this._ht_image_image0__imgo['ondragstart']=function() { return false; };
			this._ht_image_image0.appendChild(this._ht_image_image0__imgo);
			this._ht_image_image0.ggId="ht_image_image";
			this._ht_image_image0.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._ht_image_image0.ggVisible=true;
			this._ht_image_image0.className='ggskin ggskin_svg ';
			this._ht_image_image0.ggType='svg';
			hs ='';
			hs+='cursor : pointer;';
			hs+='height : 32px;';
			hs+='left : -16px;';
			...
			hs+='width : 32px;';
			hs+='pointer-events:auto;';
			this._ht_image_image0.setAttribute('style',hs);
			this._ht_image_image0.style[domTransform + 'Origin']='50% 50%';
			...
			me._ht_image_image0.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._ht_image_image0.onmouseover=function (e) {
				me._ht_image_image0__img.style.visibility='hidden';
				me._ht_image_image0__imgo.style.visibility='inherit';
			}
			this._ht_image_image0.onmouseout=function (e) {
				me._ht_image_image0__img.style.visibility='inherit';
				me._ht_image_image0__imgo.style.visibility='hidden';
			}
			this._ht_image_image0.ggUpdatePosition=function (useTransition) {
			}
			this.__div.appendChild(this._ht_image_image0);
			this._tt_ht_image0=document.createElement('div');
			this._tt_ht_image0__text=document.createElement('div');
			this._tt_ht_image0.className='ggskin ggskin_textdiv';
			this._tt_ht_image0.ggTextDiv=this._tt_ht_image0__text;
			this._tt_ht_image0.ggId="tt_ht_image";
			this._tt_ht_image0.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._tt_ht_image0.ggVisible=false;
			this._tt_ht_image0.className='ggskin ggskin_text ';
			this._tt_ht_image0.ggType='text';
			hs ='';
			hs+='z-index: 100;';
			hs+='height : 20px;';
			hs+='left : -50px;';
			...
			hs+='width : 98px;';
			hs+='pointer-events:auto;';
			this._tt_ht_image0.setAttribute('style',hs);
			this._tt_ht_image0.style[domTransform + 'Origin']='50% 50%';
			hs ='position:absolute;';
			hs+='cursor: default;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			...
			hs+='padding: 2px 5px 2px 5px;';
			hs+='overflow: hidden;';
			this._tt_ht_image0__text.setAttribute('style',hs);
			this._tt_ht_image0__text.innerHTML=me.hotspot.title;
			this._tt_ht_image0.appendChild(this._tt_ht_image0__text);
			...
			me._tt_ht_image0.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			me._tt_ht_image0.ggCurrentLogicStateVisible = -1;
			this._tt_ht_image0.ggUpdateConditionTimer=function () {
				var newLogicStateVisible;
				if (
					(me.elementMouseOver['_div'] == true)
				)
			...
			this._tt_ht_image0.ggUpdatePosition=function (useTransition) {
				this.style[domTransition]='none';
				this.ggTextDiv.style.left=((98-this.ggTextDiv.offsetWidth)/2) + 'px';
			}
			this.__div.appendChild(this._tt_ht_image0);
			this.hotspotTimerEvent=function() {
				setTimeout(function() { me.hotspotTimerEvent(); }, 10);
				if (me.elementMouseOver['_div']) {
				}
				me._tt_ht_image0.ggUpdateConditionTimer();
			}
			this.hotspotTimerEvent();
		} else
